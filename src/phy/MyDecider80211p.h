 ...
 * @see Decider80211p
 */
class MyDecider80211p: public BaseDecider {
	...
	protected:
		 ...
		 */
		bool collectCollisionStats = true;
	...
	public:
		 ...
		 */
		MyDecider80211p(DeciderToPhyInterface* phy,
		              double sensitivity,
		              double ccaThreshold,
		              bool allowTxDuringRx,
		              double centerFrequency,
